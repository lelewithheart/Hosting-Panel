    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-neutral-900 text-gray-900 dark:text-gray-100">
      <form onSubmit={handleSubmit} className="bg-white dark:bg-neutral-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-neutral-700 w-full max-w-md">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">Secure login to your bot dashboard</p>
        </div>
        ...
        <input
          ...
          required
        />
        <button type="submit" disabled={submitting} className={`bg-blue-600 hover:bg-blue-700 text-white p-2 w-full rounded ${submitting ? "opacity-60 cursor-not-allowed" : ""}`}>{submitting ? "Logging in…" : "Login"}</button>
        <p className="mt-2">
